...
%I'm using 5.19 equation to calculate the BF but it's similar because the projection also uses the difference \Delta Z of the signal. \mynote{Verify if this is the correct equation. I'm using 5.19 with the square of $(L/RB)^2$}
