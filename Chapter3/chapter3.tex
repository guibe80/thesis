...
\nomenclature[g-w]{$\omega$}{Angular frequency in radians, equivalent to $2 \pi$} 
\nomenclature[g-e]{$\epsilon$}{Permittivity of a material}
\nomenclature[g-r]{$\rho$}{Resistivity of a material / Blood resistivity $\simeq$ \SI{150}{\ohm\per\centi\meter}}
\nomenclature[g-s]{$\sigma$}{Conductivity of a material} 
\nomenclature[g-f]{$\phi$}{Angular phase shift / Potential field} 
\nomenclature[g-m]{$\mu$}{Viscosity of a medium} 
