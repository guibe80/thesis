...
%********************************** % Sixth Section  *************************************
\section{Impedance plethysmography devices} %Section - 3.6
\label{section impedance 7}
During the study of this document, localised BIA is the method used to determine to find the blood flow in a specific limb section of the body.


\subsection{Basal impedance}
\subsection{Plethysmography waveform}
