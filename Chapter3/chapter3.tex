...
From the electrical point of view impedance is defined as the opposition that a medium presents to either an alternating current (AC) or voltage. The impedance is equivalent to the complex ration between the voltage and the current.  
...
\begin{table}[!htpb]
	...
	\begin{tabular}{lp{0.525\textwidth}}
		...
		< \SI{1}{\milli\ampere}                &  
		\begin{tabular}[t]{@{\textbullet~}p{\textwidth}@{}} 
...
%********************************** % Sixth Section  *************************************
\section{Impedance plethysmography} %Section - 3.8
...
\nomenclature[z-APA]{APA}{Arterial pressure amplitude}
