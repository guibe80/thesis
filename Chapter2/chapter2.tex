...
\label{table:cell}
\centering
\begin{tabular}{p{2.5cm} p{1.5cm} p{3.5cm} p{6.1cm}}
\toprule
...
\begin{tabular}[t]{@{\textbullet~}p{6cm}@{}} 
...
\rvmynote{This section is poorly written. When repositioned, it needs to be more detailed. Volume and flow are not related or are the same. Be careful with this assumption.}
...
\rvmynote{UD describes measurement of Blood flow but not plethysmography. This must be put in other section.} 
