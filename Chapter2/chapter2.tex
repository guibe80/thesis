...
\subsection{Methods to measure plethysmography}
...
For measurement of changes of volume of a segment or a limb, the air plethysmography technique could be very cumbersome and not very practical. This is one of the many reasons why more techniques have been developed. The following section describes methods to detect plethysmography from a part of the body.

\subsubsection{Air plethysmography}
\label{section literature 3.1.1}
...
\subsubsection{Doppler method}
\label{section literature 3.1.2}
...
\label{section literature 3.1.3}
...
\subsubsection{Photoelectric method}
\label{section literature 3.1.4}
...
\subsubsection{Bioelectrical Impedance}
\label{section literature 3.1.5}
