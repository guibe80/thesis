...
\subsubsection{Obtaining impedance value}
...
\subsubsection{Ultrasound conversion}
...
\begin{align}
\label{eq:fshift}
f_s = \frac{V_{UD} \times 8 KHz}{3.5V}
\end{align}  
...
where $f_D$ is the Doppler frequency, $C$ is the speed of the sound, $f_0$ is the oscillation frequency of the Doppler instrument and $\theta$ the angle between the ultrasound sensor and the target vessel.
...
However, blood flow can be estimated by using averages cross-sectional area of radial arteries in the population. A study has been found that males have slight larger radial arteries than females $(2.3 \pm 0.39 and 2.11 \pm 0.29 respectively)$~\cite{ashraf2010size}. These dimensions were used to calculated the blood flow in the present experiment.
